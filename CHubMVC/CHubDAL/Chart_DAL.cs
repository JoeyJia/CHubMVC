...
namespace CHubDAL
{
    public class Chart_DAL
    {
        ...
        public List<V_DASH_TMS01> GetTMSData()
        {
            ...
            var result = ccHelper.ExecuteSqlToList<V_DASH_TMS01>(sql);
            return result;
        }
        ...
        public List<V_DASH_SHIP11> GetV_DASH_SHIP11()
        {
            ...
            var result = ccHelper.ExecuteSqlToList<V_DASH_SHIP11>(sql);
            return result;
        }
        ...
        public List<V_DASH_SHIP12> GetV_DASH_SHIP12()
        {
            ...
            var result = ccHelper.ExecuteSqlToList<V_DASH_SHIP12>(sql);
            return result;
        }
        ...
        public List<V_DASH_SHIP21> GetV_DASH_SHIP21()
        {
            ...
            var resutl = ccHelper.ExecuteSqlToList<V_DASH_SHIP21>(sql);
            return resutl;
        }
        ...
        public List<V_DASH_SHIP22> GetV_DASH_SHIP22()
        {
            ...
            var result = ccHelper.ExecuteSqlToList<V_DASH_SHIP22>(sql);
            return result;
        }
